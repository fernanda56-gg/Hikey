                ...
                <div class="md:p-4">
                    <BoxComponent>
                        ...
                        <div class="flex items-center justify-center mt-8">
                            <button type="submit" class="bg-primary-content w-full p-3 rounded-lg text-black font-bold cursor-pointer tracking-wide">Actualizar empresa</button>
                        </div>
                    </BoxComponent>
                </div>
            </form>
...
const form = useForm({
    ...
    web_address: props.company.web_address,
    tax_id: props.company.tax_id,
})

const update = () => form.put(route('companies.update', {company: props.company.id}))
