<template>
    <div class="text-neutral">
        <div class="grid md:grid-cols-2 grid-cols-1 gap-4 w-full">
            ...
            <div class="flex flex-col w-full md:ml-15">
        ...
        <div class="grid md:grid-cols-3 grid-cols-1 gap-4 w-full mt-6">
            <div class="flex flex-col w-full">
                <h1 class="uppercase font-bold text-lg">dirección</h1>
                <span class="text-lg whitespace-nowrap">{{ company.address }}</span>
            </div>
            <div class="flex flex-col w-full">
        ...
        <div class="grid md:grid-cols-3 grid-cols-1 gap-4 w-full mt-4">
            <div class="flex flex-col w-full">
            ...
            <div class="flex flex-col w-full">
                <h1 class="uppercase font-bold text-lg whitespace-nowrap">No. Identificación fiscal</h1>
