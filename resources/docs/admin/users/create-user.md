...
- [Creación de usuario](#section-create)
...
<img src="/images/admin-img/user-form.png" width="70%" height="70%"/>
<br/>

> {info} Una vez creada la cuenta el sistema enviara una notificación tanto a tu correo electrónico como al sistema, dentro del apartado de notificaciones puedes marcarla como leída o puedes eliminarla para evitar la acumulación de notificaciones.


<img src="/images/admin-img/email-user-created.png" width="30%" height="30%"/>
