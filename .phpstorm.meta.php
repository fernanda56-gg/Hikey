...
'inicio','register','register.store','projects.index','projects.create',
...
'validation.attributes.end_date','validation.attributes.last_name','validation.attributes.password',);
