...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/fernandasanchez/Herd/Hikey/public/storage' => 'string',
...
'viewLarecipe','viewAny','view','viewAccountUser','create',
'update','updateAccountUser','delete','deleteAccountUser','restore',
'forceDelete',);
...
'filesystems.disks.s3.report','filesystems.links./Users/fernandasanchez/Herd/Hikey/public/storage','larecipe.docs.route','larecipe.docs.path','larecipe.docs.landing',
...
'role_or_permission','docs.rol',);
        registerArgumentsSet('routes', 
'debugbar.openhandler','debugbar.clockwork','debugbar.assets.css','debugbar.assets.js','debugbar.cache.delete',
'debugbar.queries.explain','larecipe.search','larecipe.styles','larecipe.scripts',
'larecipe.show','login','login.store','logout',
'inicio','password.request','password.email','password.reset','password.update',
'register','register.store','verification.notice','verification.verify','verification.send',
'manage-account.trash','manage-account.recover','manage-account.create','manage-account.store','manage-account.index',
'manage-account.edit','manage-account.update','manage-account.destroy','projects.update-date','projects.trash',
'projects.recover','projects.create','projects.store','projects.index','projects.show',
'projects.edit','projects.update','projects.destroy','companies.join','companies.checkCode',
'companies.redirect','companies.listMember','companies.leave','companies.create','companies.store',
'companies.index','companies.show','companies.edit','companies.update','companies.destroy',
'clients.create','clients.projects','clients.projects.assign','clients.projects.attach','clients.projects.detach',
'clients.trash','clients.recover','clients.store','clients.index','clients.show',
'clients.edit','clients.update','clients.destroy','notifications.index','notification.seen',
'notifications.delete','my-account.index','my-account.edit-account','my-account.delete-account','my-account.profile-photo',
'storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'app','larecipe::partials.404','larecipe::partials.logo','larecipe::partials.nav','larecipe::partials.sidebar',
'vendor.larecipe.partials.404','vendor.larecipe.partials.logo','vendor.larecipe.partials.nav','vendor.larecipe.partials.sidebar','laravel-exceptions-renderer::components.badge',
...
'validation.custom.attribute-name.rule-name','validation.attributes.name','validation.attributes.description','validation.attributes.image_path','validation.attributes.start_date',
'validation.attributes.end_date','validation.attributes.last_name','validation.attributes.password','validation.attributes.phone','validation.attributes.address',
'validation.attributes.city','validation.attributes.country','validation.attributes.web_address','validation.attributes.tax_id','validation.attributes.area_id',);
